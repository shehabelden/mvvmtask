  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Consumer<SchoolConsumer>(builder: (context, schoolProvied, v) {
          return Column(
            ...
            children: [
              ...
              reusableTextField(
                  schoolProvied.schoolMap == null
                      ? schoolName
                      : schoolProvied.schoolMap!.schoolName,
                  Icons.school),
              const SizedBox(
                height: 15,
              ),
              reusableTextField(
                  schoolProvied.schoolMap == null
                      ? schoolAddress
                      : schoolProvied.schoolMap!.schoolAddress,
              ...
              reusableTextField(
                  schoolProvied.schoolMap == null
                      ? studentsNo
                      : schoolProvied.schoolMap!.numberOfStudents,
                  Icons.person),
              const SizedBox(
                height: 15,
              ),
              reusableTextField(
                  schoolProvied.schoolMap == null
                      ? teachersNo
                      : schoolProvied.schoolMap!.numberOfTeachers,
                  Icons.person),
              Padding(
                padding:
